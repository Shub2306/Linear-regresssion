...
setwd('C:\\Users\\Shubham\\Documents\\BA Case Study\\Regression Case Studies - Linear & Logistic\\Linear Regression Case')
getwd()

# importing the file
library(readxl)
li <- read_xlsx('Linear Regression Case.xlsx')
...
write.csv(summary1, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/summary1.csv")
write.csv(summary2, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/summary2.csv")
write.csv(summary3, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/summary3.csv")
...
write.csv(my_num_data, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/my_num_data.csv")
...
corrm<- cor(li[,num_var])                                 ### CORRELATION MATRIX
View(corrm)
...
View(t1_DA)
write.csv(t1_DA, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/t1_DA.csv")
...
View(t2_DA)
write.csv(t2_DA, file = "C:/Users/Shubham/Documents/BA Case Study/Regression Case Studies - Linear & Logistic/Linear Regression Case/t2_DA.csv")
